...
export function Payables() {
  ...
  return <section id="payables" className="page meg-screen payables-screen" aria-busy={loading}>
    <header className="page-head screen-heading"><div><span>PENDENTES</span><h1>Vencimentos agrupados</h1><p>Compromissos organizados por urgência, sem alterar o saldo antes da confirmação.</p></div><span className="pending-total-pill">{brl.format(totals.total)} em aberto</span></header>
