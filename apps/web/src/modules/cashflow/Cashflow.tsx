...
export function Cashflow() {
  ...
  return <section className="page cashflow-page"><header className="page-header compact"><div><span>Fluxo de caixa</span><h1>Realizado e compromissos futuros</h1><p>Receitas futuras não são tratadas como dinheiro disponível.</p></div><label className="catalog-role">Período<input type="month" value={selectedMonth} onChange={(event) => setSelectedMonth(event.target.value)} /></label></header>
