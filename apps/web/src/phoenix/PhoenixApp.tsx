...
function ReadScreen({ view, data, month }: { view: PhoenixView; data: PhoenixReadModel; month: string }) {
  ...
  if (view === 'history') return <PhoenixPlaceholder kicker="Histórico" title="Auditoria financeira" text="O histórico V15 será conectado ao log de atividade/auditoria real, não a uma cópia da tabela de lançamentos." />;
