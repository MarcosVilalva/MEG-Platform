...
assert.equal(formatBRLInput('15,00-', { allowNegative: true }), '-15,00');
assert.equal(formatBRLInput('1-500', { allowNegative: true }), '-15,00');
...
assert.equal(formatPastedBRL('1.500,00-', { allowNegative: true }), '-1.500,00');
...
assert.match(source, /incomeAmountInput', allowNegative: true/);
assert.match(source, /expenseAmountInput', allowNegative: true/);
assert.match(source, /purchaseTotalInput', allowNegative: true/);
