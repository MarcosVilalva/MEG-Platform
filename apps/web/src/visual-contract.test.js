...
const workspace = readFileSync(new URL('./adaptive-workspace.js', import.meta.url), 'utf8');
...
assert.match(workspace, /meg-dashboard-overview/);
assert.match(contract, /\.opening-alert-item \{ display: grid !important/);
assert.match(contract, /\.meg-dashboard-bottom-grid/);
