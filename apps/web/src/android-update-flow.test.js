...
const designSystem = readFileSync(new URL('./meg-design-system.css', import.meta.url), 'utf8');
...
assert.doesNotMatch(hardening, /import\(['"].*\.css/);
...
assert.match(designSystem, /data-meg-theme="dark"/);
assert.match(designSystem, /\.meg-history-panel/);
assert.match(designSystem, /dialog\.modal/);
assert.match(designSystem, /body\.native-mobile/);
