...
const reportExporter = read('../../../android/app/src/main/java/br/com/megfinancas/app/ReportExporterPlugin.java');
...
assert.match(mainActivity, /registerPlugin\(ReportExporterPlugin\.class\)/);
assert.match(reportExporter, /@CapacitorPlugin\(name = "ReportExporter"\)/);
assert.match(reportExporter, /Intent\.ACTION_SEND/);
assert.match(reportExporter, /FLAG_GRANT_READ_URI_PERMISSION/);
